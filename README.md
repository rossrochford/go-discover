# Go Discover Nodes for Cloud Providers [![Build Status](https://travis-ci.org/hashicorp/go-discover.svg?branch=master)](https://travis-ci.org/hashicorp/go-discover) [![GoDoc](https://godoc.org/github.com/rossrochford/go-discover?status.svg)](https://godoc.org/github.com/rossrochford/go-discover)
...
[Register](https://godoc.org/github.com/rossrochford/go-discover#Register)
function.

 * Aliyun (Alibaba) Cloud [Config options](https://github.com/rossrochford/go-discover/blob/master/provider/aliyun/aliyun_discover.go#L15-L28)
 * Amazon AWS [Config options](https://github.com/rossrochford/go-discover/blob/master/provider/aws/aws_discover.go#L19-L33)
 * DigitalOcean [Config options](https://github.com/rossrochford/go-discover/blob/master/provider/digitalocean/digitalocean_discover.go#L16-L24)
 * Google Cloud [Config options](https://github.com/rossrochford/go-discover/blob/master/provider/gce/gce_discover.go#L17-L37)
 * Hetzner Cloud [Config options](https://github.com/rossrochford/go-discover/blob/master/provider/hcloud/hcloud_discover.go#L17-L24)
 * Linode [Config options](https://github.com/rossrochford/go-discover/blob/master/provider/linode/linode_discover.go#L30-L41)
 * mDNS [Config options](https://github.com/rossrochford/go-discover/blob/master/provider/mdns/mdns_provider.go#L19-L31)
 * Microsoft Azure [Config options](https://github.com/rossrochford/go-discover/blob/master/provider/azure/azure_discover.go#L16-L37)
 * Openstack [Config options](https://github.com/rossrochford/go-discover/blob/master/provider/os/os_discover.go#L23-L38)
 * Scaleway [Config options](https://github.com/rossrochford/go-discover/blob/master/provider/scaleway/scaleway_discover.go#L14-L22)
 * SoftLayer [Config options](https://github.com/rossrochford/go-discover/blob/master/provider/softlayer/softlayer_discover.go#L16-L25)
 * TencentCloud [Config options](https://github.com/rossrochford/go-discover/blob/master/provider/tencentcloud/tencentcloud_discover.go#L23-L37)
 * Triton [Config options](https://github.com/rossrochford/go-discover/blob/master/provider/triton/triton_discover.go#L17-L27)
 * vSphere [Config options](https://github.com/rossrochford/go-discover/blob/master/provider/vsphere/vsphere_discover.go#L148-L155)
 * Packet [Config options](https://github.com/rossrochford/go-discover/blob/master/provider/packet/packet_discover.go#L25-L35)
 ...
 * Kubernetes [Config options](https://github.com/rossrochford/go-discover/blob/master/provider/k8s/k8s_discover.go#L32-L51)
...
```
go get -u github.com/rossrochford/go-discover/cmd/discover
```
...
```
go get -u github.com/rossrochford/go-discover
```
...
import "github.com/rossrochford/go-discover/provider/k8s"
...
[GoDoc](https://godoc.org/github.com/rossrochford/go-discover). The configuration
for the supported providers is documented in the
[providers](https://godoc.org/github.com/rossrochford/go-discover/provider)
sub-package.

## Testing

**Note: Due to the `go.sum` checksum errors referenced in [#68](https://github.com/rossrochford/go-discover/issues/68), 
